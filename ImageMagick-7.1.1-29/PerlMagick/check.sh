...
if test -x PerlMagick -a -f Makefile.aperl ; then
  ...
  ${MAKE} -f Makefile.aperl CC='/home/campbell/junk/Image-Magick-To-Wasm/emsdk/upstream/emscripten/emcc' TEST_VERBOSE=1 test
elif test -f Makefile -a -f Magick.o; then
  # Shared build test incantation
  ${MAKE} CC='/home/campbell/junk/Image-Magick-To-Wasm/emsdk/upstream/emscripten/emcc' TEST_VERBOSE=1 test
else
